...
echo "Minifying CSS..."
cd gui
cat css/screen.css css/myCss.css css/baseBox.css js/mbox/assets/mBoxCore.css js/mbox/assets/mBoxModal.css js/mbox/assets/mBoxNotice.css js/mbox/assets/mBoxTooltip.css js/mbox/assets/mForm_mod.css js/mbox/assets/mFormElement-Select.css css/Meio.Autocomplete.css css/MultiSelect.css | java -jar $YUI_COMPRESSOR --type css -o css/master.min.css

echo "Minifying JavaScript..."
cd js
java -jar $CLOSURE_COMPILER --js_output_file=mbox.min.js mbox/mBox.Core.js mbox/mBox.Modal.js mbox/mBox.Notice.js mbox/mBox.Modal.Confirm.js mbox/mBox.Tooltip.js mbox/mForm.Core.js mbox/mForm.Submit.js mbox/mForm.Element.js mbox/mForm.Element.Select.js 2>/dev/null
