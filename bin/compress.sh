...
java -jar $CLOSURE_COMPILER --js_output_file=master.min.js baseBox.js ProgressBar.js dragtable_hack.js iFrameFormRequest.js Meio.Autocomplete.js gui.js tagsets.js tagsets/Tagset.js tagsets/TagsetFactory.js tagsets/POS.js file.js edit/LineJumper.js edit/TokenSearcher.js edit/HorizontalTextPreview.js edit/PageModel.js edit/EditorModel.js edit.js settings.js MultiSelect.js
