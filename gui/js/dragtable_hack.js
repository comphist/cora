/* This code was modified to use the server-side database instead of
 * cookies for storing the permutation. --Marcel Bollmann, 2012
 */
 /*
dragtable v1.0 June 26, 2008 Dan Vanderkam,
http://danvk.org/dragtable/ http://code.google.com/p/dragtable/
...
dragtable = {
 ...
 absolutePosition: function(elt, stopAtRelative) {
  ...
  rememberDrag: function(id, a, b) {
      ...
      new_val += a + "/" + b;
      dragtable.sendRequest(new_val);
      // dragtable.createCookie(cookieName, new_val, dragtable.cookieDays);
  },

  sendRequest: function(new_val) {
      if (new_val.length>36) {
	  new_val = dragtable.optimizeHistoryString(new_val);
      }
